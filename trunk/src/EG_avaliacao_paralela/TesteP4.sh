...
mkdir Experimento/execucoes/10^7
touch Experimento/execucoes/10^7/time.txt
printf "" > Experimento/execucoes/10^7/time.txt 

for i in {1..30}
do
   echo "Execucao - $i"
   ./eg --database="problems/p4_10^7.txt"  --cores=$PCORES >> Experimento/execucoes/10^7/time.txt

done

printf "10000000\t" >> Experimento/execucoes/time.txt
./media "Experimento/execucoes/10^7/time.txt" >> Experimento/execucoes/time.txt
printf "\n" >> Experimento/execucoes/time.txt
